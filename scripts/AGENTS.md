...
- 改 `build-client.mjs` 后必须跑 `test/client-bundle.test.ts` 与 `test/dist.test.ts`，并同步 [docs/PUBLISHING.md](../docs/PUBLISHING.md) 的构建链说明；其余脚本各自的同步点见 [README.md](README.md) 的变更影响路由。
