...
- `settings-card.png`：配置卡片所在页面的整屏实拍（中文，2026-09-22 重截，2449×1223），被 [README.md](../README.md) 引用。
- `settings-card_en.png`：同一画面的英文版（同日重截，2449×1223），被 [README_en.md](../README_en.md) 引用。

> **两张卡片图已于 2026-09-22 重截完毕，与当前界面一致**。这一次它们同时追上了三处改动：
...
> （`#0084FF` 的「鲸鱼 + 知」双拼）。
> 两张只有界面语言不同，其余（版本 tag `v2.0.0-alpha.0`、开关 / 徽标现状）都按拍摄当时的真实状态拍。
